...
(() => {
  ...
  const mount = () => {
    ...
    // Avoid covering video controls; the keyboard shortcut still opens the panel.
    const visibility = () => { host.style.display = document.fullscreenElement && panel.hidden ? 'none' : ''; };
